...
function insertBtn(btnInfo){
    var btnsField=document.getElementById(btnInfo.btnGroupId);
    var btnProgress=document.createElement("div");
    var btnBar=document.createElement("div");
    if(btnInfo.playerInd){
    ...
    btnLabel.innerHTML=btnInfo.text;
    btnProgress.appendChild(btnBar);
    btnProgress.appendChild(btnLabel);
    btnsField.appendChild(btnProgress);
}

function inverseDisplay(fieldId){
